...
//            node.addAttribute("ui.style", "fill-color: white; size: 25px,25px;");                        
    ...
    public void createCityMap() {
        ...
        //la fermata si salva la linea dell'ultimo autobus passato
        cityRoadMap.getNode("0").addAttribute("linea", -1);
        cityRoadMap.getNode("6").addAttribute("linea", -1);
        cityRoadMap.getNode("7").addAttribute("linea", -1);
        cityRoadMap.getNode("9").addAttribute("linea", -1);
        cityRoadMap.getNode("15").addAttribute("linea", -1);
        cityRoadMap.getNode("47").addAttribute("linea", -1);
        cityRoadMap.getNode("18").addAttribute("linea", -1);
        cityRoadMap.getNode("19").addAttribute("linea", -1);
        cityRoadMap.getNode("20").addAttribute("linea", -1);
        cityRoadMap.getNode("29").addAttribute("linea", -1);
        cityRoadMap.getNode("30").addAttribute("linea", -1);
        cityRoadMap.getNode("35").addAttribute("linea", -1);
        cityRoadMap.getNode("36").addAttribute("linea", -1);
        cityRoadMap.getNode("33").addAttribute("linea", -1);
        cityRoadMap.getNode("34").addAttribute("linea", -1);
        cityRoadMap.getNode("25").addAttribute("linea", -1);
        cityRoadMap.getNode("26").addAttribute("linea", -1);
        cityRoadMap.getNode("8").addAttribute("linea", -1);
        cityRoadMap.getNode("27").addAttribute("linea", -1);
        cityRoadMap.getNode("21").addAttribute("linea", -1);
        cityRoadMap.getNode("22").addAttribute("linea", -1);
        cityRoadMap.getNode("28").addAttribute("linea", -1);
        cityRoadMap.getNode("51").addAttribute("linea", -1);
        cityRoadMap.getNode("32").addAttribute("linea", -1);
        cityRoadMap.getNode("38").addAttribute("linea", -1);
        cityRoadMap.getNode("12").addAttribute("linea", -1);
        cityRoadMap.getNode("1").addAttribute("linea", -1);
        cityRoadMap.getNode("31").addAttribute("linea", -1);
        cityRoadMap.getNode("37").addAttribute("linea", -1);
        cityRoadMap.getNode("39").addAttribute("linea", -1);
        cityRoadMap.getNode("13").addAttribute("linea", -1);
        cityRoadMap.getNode("23").addAttribute("linea", -1);
        cityRoadMap.getNode("16").addAttribute("linea", -1);
        cityRoadMap.getNode("24").addAttribute("linea", -1);
        cityRoadMap.getNode("14").addAttribute("linea", -1);
        cityRoadMap.getNode("48").addAttribute("linea", -1);
        cityRoadMap.getNode("10").addAttribute("linea", -1);
        cityRoadMap.getNode("11").addAttribute("linea", -1);
        cityRoadMap.getNode("40").addAttribute("linea", -1);
        cityRoadMap.getNode("49").addAttribute("linea", -1);
        cityRoadMap.getNode("50").addAttribute("linea", -1);
        cityRoadMap.getNode("2").addAttribute("linea", -1);
        cityRoadMap.getNode("3").addAttribute("linea", -1);
        cityRoadMap.getNode("4").addAttribute("linea", -1);
        cityRoadMap.getNode("5").addAttribute("linea", -1);
        cityRoadMap.getNode("17").addAttribute("linea", -1);
        cityRoadMap.getNode("41").addAttribute("linea", -1);
        cityRoadMap.getNode("42").addAttribute("linea", -1);
        cityRoadMap.getNode("44").addAttribute("linea", -1);
        cityRoadMap.getNode("43").addAttribute("linea", -1);
        cityRoadMap.getNode("45").addAttribute("linea", -1);
        cityRoadMap.getNode("46").addAttribute("linea", -1);
